export const Data = [
  ...
  },
  {
    ...
    person: 2,
    facilities: {
      electronics: ["ทีวี", "เครื่องปรับอากาศ", "เครื่องทำน้ำอุ่น", "Wifi"],
      ferniture: ["เตียงนอน", "ตู้เสื้อผ้า", "โต๊ะเครื่องแป้ง", "โต๊ะทำงาน"]
    },
    price: 450,
    distance: 2850,
  ...
  },
  {
    ...
    person: 2,
    facilities: {
      electronics: ["เครื่องปรับอากาศ", "เครื่องทำน้ำอุ่น", "ตู้เย็น", "Wifi"],
      ferniture: ["เตียงนอน", "ตู้เสื้อผ้า"]
    },
    price: 600,
    distance: 900,
  ...
  },
  {
    ...
    person: 2,
    facilities: {
      electronics: ["ทีวี", "เครื่องทำน้ำอุ่น", "Wifi"],
      ferniture: ["เตียงนอน", "ตู้เสื้อผ้า", "โต๊ะเครื่องแป้ง"]
    },
    price: 400,
    distance: 2000,
  ...
  },
  {
    ...
    person: 2,
    facilities: {
      electronics: ["แอร์", "เครื่องทำน้ำอุ่น", "ตู้เย็น"],
      ferniture: ["เตียงนอน", "ตู้เสื้อผ้า"]
    },
    price: 600,
    distance: 50,
  ...
  },
  {
    ...
    person: 2,
    facilities: {
      electronics: ["ทีวี", "แอร์", "เครื่องทำน้ำอุ่น", "ตู้เย็น", "Wifi"],
      ferniture: ["เตียงนอน", "ตู้เสื้อผ้า", "โต๊ะเครื่องแป้ง", "โต๊ะทำงาน"]
    },
    price: 500,
    distance: 400,
